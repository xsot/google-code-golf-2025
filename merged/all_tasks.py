...
# 💎 task 396: 147 bytes, gold, https://arcprize.org/play?task=fcb5c309
p=lambda m,X=8,f=0:[[sum({*e*sum(m,[-f])})for e in s]for x in range(18)for r in m+[[]]if(f:=[]<X*r[x:x+1]in(s:=r[x:x+X],[f]*X)and r[x])]or p(m,X-1)
