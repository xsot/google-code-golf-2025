...
# task 257: 75 vs 81 bytes for gold, https://arcprize.org/play?task=a68b268e
...
# task 282: 83 vs 86 bytes for gold, https://arcprize.org/play?task=b60334d2
...
def p(g):
 ...
 return g
# task 364: 163 bytes, gold, https://arcprize.org/play?task=e509e548
...
# task 378: 244 (250 unzipped) vs 145 bytes for gold, https://arcprize.org/play?task=ec883f72
def p(g):
 ...
 return g
# task 379: 141 vs 142 bytes for gold, https://arcprize.org/play?task=ecdecbb3
import re
...
p=lambda a:[*zip(*a)][::-1]
# task 381: 100 vs 87 bytes for gold, https://arcprize.org/play?task=ef135b50
import re
