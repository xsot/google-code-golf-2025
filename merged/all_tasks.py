...
# task 308: 249 (266 unzipped) vs 238 bytes for gold, https://arcprize.org/play?task=c8cbb738
def p(g):
...
def p(g,k=3):
 ...
 return-k*g or p([*map(list,zip(*g[::-1]))],k-1)
# task 371: 109 vs 114 bytes for gold, https://arcprize.org/play?task=e9614598
def p(a):
